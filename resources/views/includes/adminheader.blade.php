...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		<a href="index.html" class="navbar-brand"><img class="m-r-5" src="/assets/img/logo/geantonino" alt="" height="20" width="20"><b><h9>G.E Antonino Incorporated</h9></b></a>
		@if (!$sidebarHide)
	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu media-list dropdown-menu-right">
				<li class="dropdown-header">NOTIFICATIONS asdasdsa(5)</li>
				<li class="media">
					<a href="javascript:;">
		...
		<li class="dropdown navbar-user">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				...
				<span class="d-none d-md-inline">Carol C. Baluyot</span> <b class="caret"></b>
			</a>
